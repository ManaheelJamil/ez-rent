...
import Edit from "../../component/my-listening/edit"
...
const EditProduct = () => {
    ...
    return (
        <div>
            <head>
                <title>Ez-Rent |  Edit-product </title>
            </head>
            <Navbar />
            <div className='2xl:w-[1500px] xl:w-[1200px] lg:w-[900px] md:w-[900px] w-full md:mx-auto  my-36'>
                <div className='lg:flex   gap-10'>
                    <div className='2xl:w-[600px] xl:w-[500px] md:w-full  mx-auto'>
                    ...
                    <div className='mx-5' >
                        ...
                        <div className='md:flex xl:gap-10 gap-6 mt-7'>
                            <div>
                                ...
                                <div className=' w-full  mt-2  rounded-[15px]'>
                                    <input type="text" placeholder="Sony play station 5" className='text-xs cursor-pointer 2xl:w-[500px] px-5 xl:w-[450px] md:w-[330px] w-[95%]  outline-none focus:border-[#404EED] border-2 rounded-[15px] 2xl:py-3 py-3' />
                                </div>
                            </div>
                            <div className='flex xl:gap-10 gap-6 md:mt-0 mt-5 '>
                                <div>
                                    ...
                                    <div className='mt-2 rounded-[15px]'>
                                        <input type="text" placeholder="40" className='cursor-pointer 2xl:w-[220px] text-xs px-3 xl:w-[180px] w-[130px] outline-none focus:border-[#404EED] border-2 rounded-[15px] 2xl:py-3 py-2' />
                                    </div>
                                </div>
                                <div>
                                    <label className='2xl:text-lg text-xs'>Quantity*</label>
                                    <div className='mt-2 rounded-[15px]'>
                                        <input type="text" placeholder=" 5" className='cursor-pointer 2xl:w-[220px]  px-5 text-xs xl:w-[180px] w-[130px] outline-none focus:border-[#404EED] border-2  rounded-[15px] 2xl:py-3 py-2' />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='md:flex xl:gap-10 gap-6 mt-7'>
                            <div>
                                ...
                                <div className=' w-full mt-2   rounded-[15px]'>
                                    <input type="text" placeholder='Lorem ipsum dolor sit amet' className='cursor-pointer 2xl:w-[520px] px-5 text-xs xl:w-[450px] md:w-[350px] w-[95%] outline-none focus:border-[#404EED] border-2   rounded-[15px] 2xl:py-3 py-2' />
                                </div>
                            </div>
                            <div className='flex xl:gap-10 gap-6 md:mt-0 mt-5'>
                                <div>
                                    ...
                                    <div className='mt-2  rounded-[15px]'>
                                        <input type="text" placeholder="Delievery collection fee" className='cursor-pointer 2xl:w-[220px] px-5 text-xs xl:w-[180px] w-[130px] outline-none focus:border-[#404EED] border-2 rounded-[15px] 2xl:py-3 py-2' />
                                    </div>
                                </div>
                                <div>
                                    <label className='2xl:text-lg text-xs'>Refundable deposit*</label>
                                    <div className='mt-2 rounded-[15px]'>
                                        <input type="text" placeholder='Refundable Deposit' className='cursor-pointer 2xl:w-[220px] px-5 text-xs xl:w-[180px] w-[130px]  outline-none focus:border-[#404EED] border-2 rounded-[15px] 2xl:py-3 py-2' />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className='md:flex xl:gap-10 gap-6 mt-7'>
                            <div>
                                ...
                                <div>
                                    <input type="text" placeholder='The PlayStation 5 is the ultimate gaming console that delivers unparalleled performance and breathtaking experiences. Immerse yourself in stunning 4K graphics.' className='cursor-pointer  border-2 mt-2 rounded-[15px] px-5 text-xs 2xl:h-[91px] 2xl:w-[780px] xl:w-[680px] md:w-[500px] outline-none focus:border-[#404EED] w-full h-[80px]' />
                                </div>
                            </div>
                        ...
                        <div className=' gap-10 mt-7'>
                            <div>
                                ...
                                <div className='w-full  mt-2 rounded-[15px]'>
                                    <input type="text" placeholder="Lorem Ipsum" className='text-xs cursor-pointer w-[95%] px-5 outline-none focus:border-[#404EED] border-2 rounded-[15px] 2xl:py-3 py-2' />
                        ...
                        <div className=' md:flex justify-between w-full md:mt-20 mt-5'>
                            ...
                            <button className='bg-[#404EED] 2xl:py-3 py-2 rounded-full 2xl:w-80 w-52 mt-3 2xl:text-xl text-xs text-center 2xl:h-14 h-12  flex md:mt-14 items-center justify-center  right-0 text-white'>Update Product</button>
                        </div>
                    </div>
                </div>
            </div>

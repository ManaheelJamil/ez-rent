    ...
    return (
        ...
        <title>Ez-Rent |  My-Borrow </title>
            ...
            <div className="2xl:w-[1000px] xl:w-[800px] lg:w-[700px] md:w-[600px] w-full md:mx-auto  2xl:my-44 xl:my-32  md:my-44 my-24 xl:text-sm text-[11px] font-bold md:font-medium  text-gray-500 ">
                <h1 className='xl:text-3xl lg:text-2xl mx-5 font-bold text-black'>My Borrow</h1>
          ...
          `}
                    ...
                    <button
                        className={`className="inline-block 2xl:text-md lg:text-xs active:bg-[#404EED] text-[10px] md:block hidden text-black rounded-full 2xl:py-4 lg:py-3 py-2 mt-5 w-48 bg-[#E3F1FF]  border-b-2 background border-blue-600" `}
                        ...
                        <p>
                            ...
                            {open && (
                                <div className='fixed inset-0 bg-gray-500 bg-opacity-75 '>
                                    <div className='2xl:w-[570px] md:w-[450px] w-full rounded-xl 2xl:p-10 p-5 space-y-2 bg-white border absolute 2xl:top-44 top-24 md:mx-auto  right-0 left-0 '>
                        ...
                        <p>
                            <div id="account" className='2xl:w-[1000px] 2xl:h-[408px] md:h-[350px] h-[350px] rounded-3xl border-2 xl:w-[800px] lg:w-[710px] md:w-[600px] md:mx-auto md:mt-14 mx-5  font-bold'>
                                <div className='flex bg-[#E3F1FF] justify-between items-center 2xl:h-[160px] h-[120px] rounded-3xl border 2xl:px-10 px-5'>
                                    ...
                                    <div>
                                        <button className='2xl:py-3 py-2 rounded-full 2xl:w-52 md:w-44 w-32 2xl:text-lg text-xs bg-white text-center border'>View Order</button><br />

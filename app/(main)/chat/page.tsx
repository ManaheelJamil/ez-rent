...
import LesseChat from "../../component/chat/LesseChatPopup"
const Chat = () => {
    const [open2, setOpen2] = useState(false);

    const toggleToOpenPopup = () => {
        console.log("hello")
        setOpen2(true);
        setIsOpen(false);
    };
    ...
    return (
        <div>
            ...
            <div className='flex h-[79vh]'>
                {/* left side  */}
                <div className='2xl:w-[470px]  lg:w-[370px]  w-full 2xl:pt-32 pt-20   md:mx-10 mx-3'>
                    <div className='2xl:w-[470px] lg:w-[370px]  w-full flex justify-between items-center'>
                        <h1 className='2xl:text-3xl text-lg text-[#111827] font-bold'>Chats (All)</h1>
                        <div className="relative  text-left">
                            <div>
                                <button
                                    onClick={toggleDropdown}
                                    type="button"
                                    className="inline-flex text-gray-700  rounded-full items-center      2xl:px-4 px-3 2xl:py-1  2xl:text-2xl md:text-lg  text-sm font-medium  "
                                >
                                    All
                            ...
                            {isOpen && (
                                <div className="right-5 z-10 absolute text-center mt-2 w-[170px] rounded-2xl shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                                    <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                        <a href="#" onClick={handleDropdownItemClick} className="block px-4 pt-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                                            All
                                            <hr className='my-2' />
                                        </a>
                                        <a href="#" onClick={handleDropdownItemClick} className="block px-4 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" >
                                            Borrowing
                                            <hr className='my-2' />
                                        </a>
                                        <a href="#" onClick={handleDropdownItemClick} className="block px-4  text-sm text-gray-700 hover:bg-gray-100" role="menuitem" >
                    ...
                    <div className='flex lg:gap-10 gap-5 items-center mt-10 2xl:my-10 my-5'>
                        <h1 className='2xl:text-3xl text-lg text-[#111827]  font-bold'>Inbox</h1>

                        {/* <Link href="/chat">
                            <button className='lg:block hidden bg-[#404EED] py-2 w-28 text-xs rounded-full text-white'>Lesse Chat</button>
                        </Link>
                        <Link href="/lessor-Chat">
                            <button className='lg:block hidden bg-[#404EED] py-2 w-28 text-xs rounded-full text-white'>Lessor Chat</button>

                        </Link> */}

                    </div>
                    <div className='lg:block hidden'>
                        <div className='flex 2xl:gap-5 gap-3 bg-[#E3F1FF] border mt-5 2xl:p-3 p-2 rounded-xl'>
                            <Image src="/orange-icon.png" alt="icon" width={53} height={53} className='2xl:w-[53px] 2xl:h-[53px] w-[40px] h-[40px]' />
                            <div className='w-full p-2'>
                                <h1 className='text-black flex justify-between items-center 2xl:text-lg text-sm'>John Doe<h1 className='text-xs text-[#787878] '>10:10 PM</h1></h1>
                                <p className='text-[#787878] 2xl:text-md text-xs'> I'm looking to rent it for a week. Can you co...</p>
                            </div>
                        </div>
                    </div>
                    <div className='lg:hidden block'>
                        <div className='flex 2xl:gap-5 gap-3 bg-[#E3F1FF] border mt-5 2xl:p-3 p-2  rounded-xl w-full' onClick={toggleToOpen1}>
                            <Image src="/icon.png" alt="icon" width={70} height={70} className='2xl:w-[70px] 2xl:h-[70px] w-[40px] h-[40px]' />
                            <div className='w-full px-2'>
                                <h1 className=' text-black flex justify-between  w-full items-center 2xl:text-lg text-sm'>Lesse Chat<h1 className='text-xs  text-[#787878]  '>10:10 PM</h1></h1>
                        ...
                        <div className='flex 2xl:gap-5 gap-3 bg-[#E3F1FF] border mt-5 2xl:p-3 p-2 rounded-xl' onClick={toggleToOpen}>
                            <Image src="/orange-icon.png" alt="icon" width={53} height={53} className='2xl:w-[53px] 2xl:h-[53px] w-[40px] h-[40px]' />
                            <div className='w-full px-2'>
                                <h1 className='text-black flex justify-between items-center 2xl:text-lg text-sm'>Lessor Chat<h1 className='text-xs text-[#787878] '>10:10 PM</h1></h1>
                                <p className='text-[#787878] 2xl:text-md text-xs'> I'm looking to rent it for a week. Can you co...</p>
                            </div>
                        </div>
                    </div>
                ...
                {/* right side */}
                <div className='w-full bg-[#E3F1FF] lg:block hidden md:pt-16 pt-12 md:px-10 px-5 md:h-screen'>
                    <div className='flex justify-between items-center pt-5'>
                        <div className='flex gap-3  justify-between items-center'>
                            <Image src="/orange-icon.png" alt="icon" width={53} height={53} className='2xl:w-[53px] 2xl:h-[53px] w-[40px] h-[40px]' />
                            <div>
                                <h1 className='text-[#787878] flex font-bold justify-between items-center 2xl:text-lg text-sm'>JohnDoe</h1>
                    ...
                    <div className='w-full lg:flex 2xl:gap-10 gap-5  ' >
                        <div className='lg:flex bg-[#E5F2FF] 2xl:w-[700px] lg:w-[450px] justify-between items-center'>
                            ...
                            <div className='flex gap-5 '>
                                <button className='2xl:py-3 lg:block hidden py-2 2xl:text-lg text-xs text-white rounded-full 2xl:w-32 w-24 bg-[#4CAF50]'>Accept</button>

                                <button className='2xl:py-3 py-2 lg:block hidden 2xl:text-lg text-xs text-white rounded-full 2xl:w-32 w-24 bg-[#D60000]'>Decline</button>
                            </div>
                        </div>
                        <div className='2xl:w-[390px] w-[300px] 2xl:h-[150px] h-[90px] lg:mt-0 mt-5 2xl:p-7 p-5 rounded-2xl bg-white border'>
                            <h1 className='text-[#404EED] 2xl:text-sm text-[10px]  flex gap-2  font-bold items-center'>Quantity : <input type="number" id="points" name="points" step="3" placeholder="1" className='w-10 outline-none focus:border-[#404EED] border-2' />
                            </h1>
                            <h1 className='text-[#404EED] 2xl:text-sm text-[10px] flex gap-1  mt-1 font-bold items-center'>Duration:
                                <DatePicker selected={startDate} onChange={(date: any) => setStartDate(date)} className='2xl:w-20 md:w-16 w-16 md:text-[10px] text-[10px] text-center  rounded-md 2xl:py-1 md:py-0 py-1 outline-none border-2 focus:border-[#404EED]' />
                                <GoDash className=" font-bold" />

                                <DatePicker selected={endDate} onChange={(date: any) => setEndDate(date)} className='2xl:w-20 md:w-16  w-16 md:text-[10px] text-[10px] text-center  rounded-md 2xl:py-1 md:py-0 py-1 outline-none border-2 focus:border-[#404EED]' />
                            </h1>
                            <h1 className='text-[#404EED] 2xl:text-sm text-[10px]  font-bold  flex gap-2 items-center'>Negotiated price: <h1 className='text-[#787878] '>$30</h1></h1>
                        </div>
                    </div>
                    <hr className='border-2 my-5' />
                    <div className=' overflow-x-hidden overflow-y-scroll scrollbar-hide grid gap-5 grid-col-1 h-2/4 '>
                        ...
                        <div className='2xl:p-5 rounded-2xl  2xl:w-[326px] mb-32 p-3 md:w-[280px] w-[200px] bg-[#404EED] text-white 2xl:text-lg text-xs '><p>
                            ...
                            week?<h1 className='text-[#CACACA] mt-3 text-xs float-right'>10:10</h1>
                        </p>
                        </div>

                    </div>
                    {/* <div className='bottom-0 fixed  w-[70%] right-0'> */}
                ...
                {istoOpen && (
                    <div className='absolute top-0 right-0 left-0'>
                        <div className='w-full bg-[#E3F1FF]  placeholder:md:pt-16 pt-12 md:px-10 px-5'>
                            <div className='fixed top-0 left-5 right-5 bg-[#E3F1FF]' >
                                <div className='flex justify-between items-center pt-20'>
                                    ...
                                    <RxCross2 onClick={toggleToClose} className="lg:hidden block" />
                                </div>

                                <hr className='2xl:border-2 border 2xl:my-5 my-3' />
                                <div className='w-full lg:flex 2xl:gap-10 gap-5 justify-between'>
                                    <div className='lg:flex bg-[#E5F2FF] 2xl:w-[850px] lg:w-[450px] justify-between items-center'>
                                        <div className=' 2xl:h-[168px] xl:h-[100px] lg:h-[110px] h-[80px]  rounded-2xl 2xl:gap-5 gap-3 flex  2xl:p-3 p-2 '>
                                            <Link href="/product-detail">
                                                <Image src="/Mask.png" alt="image" width={144} height={40} className='2xl:w-[144px] xl:w-[70px] lg:w-[90px] w-[60px]' />
                                    ...
                                    <div className='2xl:w-[390px] w-[300px] 2xl:h-[150px] h-[90px] lg:mt-0 mt-5 2xl:p-7 p-3 rounded-2xl bg-white border'>
                                        <h1 className='text-[#404EED] 2xl:text-sm text-[10px]  flex gap-2  font-bold items-center'>Quantity : <input type="number" id="points" name="points" step="3" placeholder="1" className='w-10 outline-none focus:border-[#404EED] border-2' />
                                        </h1>
                                        <h1 className='text-[#404EED] 2xl:text-sm text-[10px] flex gap-1  mt-1 font-bold items-center'>Duration:
                                            <DatePicker selected={startDate} onChange={(date: any) => setStartDate(date)} className='2xl:w-20 md:w-16 w-16 md:text-[10px] text-[10px] text-center  rounded-md 2xl:py-1 md:py-0 py-1 outline-none border-2 focus:border-[#404EED]' />
                            ...
                            <div className=' grid mt-80 gap-10 grid-col-1 '>
                                <div className='2xl:p-5 p-3 rounded-2xl 2xl:mt-20 mt-5 2xl:w-[326px] 2xl:text-lg text-xs md:w-[280px] w-[200px] bg-[#404EED] text-white'><p>
                                    Hello! I'm interested in renting a PS5.
                                    Can you provide me with some
                                    information?<h1 className='text-[#CACACA] text-xs  mt-3 float-right'>10:10</h1>
                ...
                {toOpen && (
                    <div>
                        <div className='absolute top-0 right-0 left-0'>
                            <div className='w-full bg-[rgb(227,241,255)] md:pt-16 pt-12 md:px-10 px-5 '>
                                <div className='fixed top-0 right-5 left-5 bg-[#E3F1FF]'>
                                ...
                                <div className='pt-96 grid gap-10 grid-col-1 '>
                                    <div className='2xl:p-5 p-3 rounded-2xl 2xl:mt-20 mt-5 2xl:w-[326px] 2xl:text-lg text-xs md:w-[280px] w-[200px] bg-[#404EED] text-white'><p>
                                        Hello! I'm interested in renting a PS5.
                                        Can you provide me with some
                                        information? <h1 className='text-[#CACACA] text-xs mt-3 float-right'>10:10</h1>

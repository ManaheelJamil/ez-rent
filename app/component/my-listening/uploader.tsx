...
function UploadImage() {
    ...
    return (
        <div className="flex lg:flex-col md:flex-row flex-col md:ml-0 gap-5">
            <div className='2xl:w-[300px] lg:w-[250px] md:w-[300px] w-[250px] mx-auto text-center 2xl:py-28 py-24 bg-[#F1F5F9] border border-[#CACACA] rounded-2xl'>
                <label className="btn btn-default" htmlFor="inputFile">
                    ...
                    <div className="fa fa-upload fa-2x">
                        ...
                        <h1 className="text-[#404EED] text-md">click to browse </h1>
                    </div>
                </label>
                <input
                    id="inputFile"

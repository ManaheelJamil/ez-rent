...
import ProductData from "../../../data/category-product.json"
...
const CategoryDetail = () => {
    ...
    return (
        <div>
            <div className=' grid lg:grid-cols-3 md:grid-cols-2 justify-center grid-cols-1 gap-5 mt-12'>
                            ...
                            <div key={index} className=''>
                                <div className='relative lg:w-auto w-72 mx-auto'>
                                    <Link href="/product-detail">
                                        <Image src={item.image} alt="image" width={400} height={400} className='md:w-[400px] mx-auto w-[330px]' />
                                ...
                                <div className='flex justify-between lg:w-auto w-64 mx-auto md:mx-2 mt-5' >
                                    <div >
                                        <h1 className='2xl:text-[20px] lg:text-[16px]   font-semibold'>Backpack</h1>
                                        <p className='2xl:text-[16px] text-[10px] text-[#787878]'>Lorem ipsum dolor sit amet</p>
                                    </div>
                                    <div>
                                        <button className='text-[12px] border border-1 rounded-lg ml-3 border-[#404EED] p-1'>$40/d</button>
                                    </div>
                                </div>
